...
// Строит AVRO-схемы из всех файлов в папке, построенных Confluence
object ConfluenceSchemaBuilderMain extends App {
  if(args.length < 3) {
    println("usage: (input directory) (output directory) (namespace)")
    System.exit(0)
  }
